...
namespace ISOB_2Client
{
    class Client
    {
        ...
        // конечные точки для соединения с сервером аутентификации
        ...
        public void Register(string login)
        {
            ...
            Console.WriteLine($"Sending client identifier '{login}' to the authentication server (AS).");
        ...
        public void Listen()
        {
            ...
            try
            {
                while (true)
                {
                    // входящие данные / для ip адреса и порта
                    ...
                    switch (message.Type)
                    {
                        case MessageType.AsToC:
                            ...
                            // восстанавливаем данные после шифрования
                            ...
                            Console.WriteLine("AS to C complete!");
                        ...
                        case MessageType.TgsToC:
                            ...
                            Console.WriteLine("TGS to C complete");
                            break;
