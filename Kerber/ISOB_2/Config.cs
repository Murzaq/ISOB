...
namespace ISOB_2
{
    public static class Config
    {
        ...
        public const int TGS_port = 8002;
        public const int SS_port = 8003;
        
        public const string tgs = "tgs";
        public const string SS_ID = "SS_ID";

        // ключи шифрования для разных этапов
        ...
        // определение продолжительности действия билетов для аутентификации и выдачи разрешений
